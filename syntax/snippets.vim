...
syn match snipAction "^\%(pre_expand\|post_expand\|done_expand\|post_jump\).*$" contains=snipActionKeyword display skipwhite
syn match snipActionKeyword "\%(pre_expand\|post_expand\|done_expand\|post_jump\)" contained nextgroup=snipActionValue skipwhite display
